...
#include "PhaseDistCurve.h"

constexpr auto fxChorus     = 0;
constexpr auto fxDistort    = 1;
constexpr auto fxDelay      = 2;
constexpr auto fxReverb     = 3;
...
public:
    ...
    struct OSCParams
    {
        ...
        gin::Parameter::Ptr enable, voices, tune, finetune, level, pos, detune, spread, pan, bend, retrig, oversampling;
    ...
    struct FilterParams
    {
        ...
        gin::Parameter::Ptr enable, type, keyTracking, velocityTracking,
                            ...
                            attack, decay, sustain, release, wt1, wt2;
    ...
    struct FXParams
    {
        ...
        gin::Parameter::Ptr fx1, fx2, fx3, fx4, distMode;
    ...
    PhaseDistCurve phaseDistCurves[Cfg::numOSCs] = {{-10.0f, 10.0f}, {-10.0f, 10.0f}};
    PhaseDistCurve gainCurves[Cfg::numOSCs] = {{0.0f, 1.0f, true}, {0.0f, 1.0f, true}};

    gin::Wavetable osc1Tables;
    gin::Wavetable osc2Tables;
    InterpPhaseDistortion osc1PD {phaseDistCurves[0], gainCurves[0]};
    InterpPhaseDistortion osc2PD {phaseDistCurves[1], gainCurves[1]};
...
using PluginProcessor = WavetableAudioProcessor;